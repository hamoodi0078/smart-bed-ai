...
def get_device_controls(request: Request, current_user: dict = Depends(get_current_user)) -> dict[str, Any]:
    from web_server import mobile_device_controls as _ws
    return _ws(request=request)


@router.post("/v1/mobile/device-controls")
async def upsert_device_controls(request: Request, current_user: dict = Depends(get_current_user)) -> dict[str, Any]:
...
def bed_pairing_status(request: Request, current_user: dict = Depends(get_current_user)) -> dict[str, Any]:
    from web_server import mobile_bed_pairing_status as _ws
    return _ws(request=request)


@router.post("/v1/mobile/bed/pair")
async def bed_pair(request: Request, current_user: dict = Depends(get_current_user)) -> dict[str, Any]:
...
async def bed_unpair(request: Request, current_user: dict = Depends(get_current_user)) -> dict[str, Any]:
...
def list_devices(request: Request, current_user: dict = Depends(get_current_user)) -> dict[str, Any]:
...
async def create_device_command(request: Request, current_user: dict = Depends(get_current_user)) -> dict[str, Any]:
...
def device_command_status(command_id: str, request: Request, current_user: dict = Depends(get_current_user)) -> dict[str, Any]:
...
async def device_command_feedback(command_id: str, request: Request, current_user: dict = Depends(get_current_user)) -> dict[str, Any]:
