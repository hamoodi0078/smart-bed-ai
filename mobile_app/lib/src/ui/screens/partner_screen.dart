...
class _PartnerModeScreenState extends State<PartnerModeScreen> {
  ...
  static const List<_PresetData> _presets = <_PresetData>[
    _PresetData(
  ...
  Widget _buildProfileCard({
    ...
    final Color borderColor = isLinked
        ? (isActive ? SmartBedPalette.accent : SmartBedPalette.body(theme.brightness).withValues(alpha: 0.2))
        : const Color(0xFF6F7993);
    final Color iconColor = isLinked
        ? (isActive ? SmartBedPalette.accent : SmartBedPalette.body(theme.brightness))
        ...
        ..._presets.map((preset) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(14),
              border: Border.all(
                color: SmartBedPalette.body(theme.brightness).withValues(alpha: 0.1),
                width: 1,
              ),
            ),
            child: Row(
