...
class _AchievementsScreenState extends State<AchievementsScreen> {
  ...
  final List<_Achievement> _achievements = <_Achievement>[
    ...
    _Achievement(
      ...
      color: SmartBedPalette.connected,
      isUnlocked: false,
      progress: 12,
      maxProgress: 30,
      points: 100,
      ...
      child: Row(
        children: <Widget>[
          ...
          Container(
            width: 1,
            height: 40,
            color: SmartBedPalette.body(theme.brightness).withValues(alpha: 0.2),
          ),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: achievement.isUnlocked
              ? SmartBedPalette.surface(theme.brightness)
              : SmartBedPalette.surface(theme.brightness).withValues(alpha: 0.3),
          border: Border.all(
            color: achievement.isUnlocked
                ? achievement.color.withValues(alpha: 0.5)
                : SmartBedPalette.body(theme.brightness).withValues(alpha: 0.1),
          ),
        ),
        child: Row(
          children: <Widget>[
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: achievement.isUnlocked
                    ...
                    : SmartBedPalette.body(theme.brightness).withValues(alpha: 0.05),
              ),
              child: Icon(
                achievement.icon,
                color: achievement.isUnlocked
                    ? achievement.color
                    : SmartBedPalette.body(theme.brightness).withValues(alpha: 0.3),
                size: 28,
              ),
            ),
              ...
              child: Column(
                ...
                children: <Widget>[
                  Row(
                    children: <Widget>[
                      Expanded(
                        child: Text(
                          ...
                          style: TextStyle(
                            color: achievement.isUnlocked
                                ? Colors.white
                                : SmartBedPalette.body(theme.brightness).withValues(alpha: 0.5),
                            fontSize: 16,
                            fontWeight: FontWeight.w700,
                          ),
                        ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: achievement.isUnlocked
                              ? SmartBedPalette.gold.withValues(alpha: 0.2)
                              : SmartBedPalette.body(theme.brightness).withValues(alpha: 0.05),
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      color: SmartBedPalette.body(theme.brightness).withValues(alpha: 
                  ...
                  if (!achievement.isUnlocked && achievement.maxProgress > 0) ...<Widget>[
                    const SizedBox(height: 8),
                    ClipRRect(
                      borderRadius: BorderRadius.circular(4),
                      child: LinearProgressIndicator(
                        value: achievement.progress / achievement.maxProgress,
                        backgroundColor: SmartBedPalette.body(theme.brightness).withValues(alpha: 0.1),
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        color: SmartBedPalette.body(theme.brightness).withValues(alpha: 0.5),
                        fontSize: 11,
                        fontWeight: FontWeight.w600,
                      ),
                    ),
                  ],
                  if (achievement.isUnlocked && achievement.unlockedAt != null) ...<Widget>[
                    const SizedBox(height: 4),
                    Text(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            ...
            colors: <Color>[
              SmartBedPalette.surface(theme.brightness),
              SmartBedPalette.surface(theme.brightness).withValues(alpha: 0.8),
            ],
          ),
          border: Border.all(
