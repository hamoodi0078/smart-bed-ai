...
class _WindDownJourneyScreenState extends State<WindDownJourneyScreen>
  ...
  static const List<_JourneyStep> _steps = <_JourneyStep>[
    _JourneyStep(
  ...
  void _completeJourney() {
    ...
    showDialog<void>(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Row(
          children: <Widget>[
            Icon(Icons.celebration_rounded, color: SmartBedPalette.gold, size: 28),
            SizedBox(width: 10),
            Text(
              'Journey Complete!',
        ...
        content: Text(
          ...
          style: TextStyle(color: SmartBedPalette.body(theme.brightness), fontSize: 14),
        ),
        actions: <Widget>[
          FilledButton(
            onPressed: () {
          ...
          children: <Widget>[
            ...
            OutlinedButton.icon(
              ...
              style: OutlinedButton.styleFrom(
                foregroundColor: SmartBedPalette.body(theme.brightness),
                side: BorderSide(color: SmartBedPalette.body(theme.brightness)),
                padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 14),
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(14),
                ),
